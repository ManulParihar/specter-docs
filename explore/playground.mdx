...
<CardGroup cols={2}>
  ...
  <Card title="Open playground in a new tab" icon="rocket" href="/explore/playground">
    Open this Mintlify-native playground route directly.
  </Card>
...
Use this interactive playground to test the core stealth flow in your browser.
...
<Note>
The interactive playground below is rendered directly on this Mintlify page. It no longer depends on `/playground/index.html`, which Mintlify does not publish reliably in production.
</Note>
...
<div id="specter-sdk-playground-root" />

<script type="module" src="/playground/src/main.js"></script>

<Warning>
If the playground does not initialize, hard-refresh once so the page re-runs the module and import map together.
</Warning>
