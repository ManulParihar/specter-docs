...
<CardGroup cols={2}>
  ...
  <Card title="Open playground in a new tab" icon="rocket" href="/playground/index.html">
    Launch the standalone static page.
  </Card>
...
<Warning>
If the playground does not initialize, open your browser console and check whether the SDK script or stylesheet request failed.
</Warning>
